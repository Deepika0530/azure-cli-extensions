...
from .example_steps_email import step_create
from .example_steps_email import step_show
from .example_steps_email import step_list
from .example_steps_email import step_list2
from .example_steps_email import step_update
from .example_steps_email import step_delete
...
class CommunicationEmailScenarioTest(ScenarioTest):
    ...
    def test_communication_email_scenario(self, rg_2, rg):
